...
from improve_process.contours_test import color_test, black_to_red, red_to_black
...
if __name__ == '__main__':
    ...
    # red_to_black('T_11_black.png', 'a.png')
    # color_test('T_11_black_final.png', 'finally_result5.png', 'result5_con.png')
