...
from preprocess.cut1 import fill_image
...
if __name__ == '__main__':
    ...
    fill_image('T11_remove_black.png', 1024, 'T_11new.png')
    color_test('T_11new.png', 'red.png', 'result_contours.png')
    black_to_red('result_contours.png', 'red_contours.png')

    # epoch 1
    cut_2('red_contours.png', '../raw_data/round_test/part1/cut/')
    demo_part1()
    merge_temp(pic_path, '1')
    # yuan_image-----> black
    in_black_image('red_contours.png', 'T_11_black.png')
