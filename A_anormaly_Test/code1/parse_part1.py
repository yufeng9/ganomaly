...
def parse_args(phase='train'):
    ...
    if phase == 'demo':
        parser.add_argument('--demo', type=str, default='../raw_data/round_test/part1/')
    parser.add_argument('--resume', type=str, default='../model/wujiandu_result_without_Z.pkl')  # result300_0715
    parser.add_argument('--det', type=str, default='../model/wujiandu_result_without_Z.pkl')
