from code1.module import Encoder, Decoder, Discriminator
from code1.loss import GANLoss
...
class GANomaly2D(nn.Module):
    def __init__(self, r=1, device='cuda'):
        """
            Constructor
        ...
        self.optim_G = Adam(itertools.chain(self.G_E.parameters(), self.G_D.parameters()),
                            lr=0.0001)
